...
# =================================================================
# scripts/77_run_remaining_trained_arms.sh
# Resumes evaluation of remaining pre-trained arms on GPU 1:
#   1. Arm 2b (Pause Tokens Control, K=6)
#   2. Arm 3  (Continuous Latent Recurrence, K=6)
#   3. Arm 2b (Pause Tokens Control, K=32)
# Followed by paired hierarchical bootstrapping (B=10,000).
# Note: Arm 1b (Direct SFT, K=0) already completed (Pass@1: 71.20%).
# =================================================================
...
echo "================================================================="
echo "=== Phase 3: Evaluating Remaining Trained Qwen3-1.7B Arms on GPU 1 ==="
...
echo ""
echo ">>> [1/3] Running Arm 2b (Pause Tokens Control, K=6)..."
...
echo ""
echo ">>> [2/3] Running Arm 3 (Continuous Latent Recurrence, K=6)..."
python scripts/55_batched_eval_arms.py \
    --arm arm3 \
    --k_tokens 6 \
    --batch_size 16 \
...
echo ""
echo ">>> [3/3] Running Arm 2b (Pause Tokens Control, K=32)..."
python scripts/55_batched_eval_arms.py \
    --arm arm2b \
    --k_tokens 32 \
    --batch_size 16 \
...
echo ""
echo "================================================================="
echo "=== All Trained Arms Completed Successfully ==="
