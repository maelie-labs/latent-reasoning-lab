...
Saves to data/eval_results_7b.json.
Runs on cuda:1.
"""
...
OUTPUT_FILE = "data/eval_results_7b.json"
...
def main():
    print(f"=== Stage 3: Evaluating 7B Model (Discrete vs Recurrent) on {DEVICE} ===")
    ...
    # Define Recurrent Conditions to Evaluate
    conditions = [
    ...
    # Calculate speedup vs discrete baseline
    ...
    print("\n" + "="*110)
    print("7B BENCHMARK EVALUATION SUMMARY TABLE")
    print("="*110)
