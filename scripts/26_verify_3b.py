#!/usr/bin/env python3
"""
scripts/26_verify_3b.py
Architectural verification and norm-scaling factor derivation for Qwen2.5-3B-Instruct on GPU 0.
Tests pure uncompressed bfloat16 loading, GQA attention layout, and embedding space dynamics.
"""
...
def main():
    ...
    out_file = os.path.join(out_dir, "3b_profiling_results.json")
