...
"""
13_train_lora_7b.py
Curriculum LoRA fine-tuning for continuous latent recurrence on DeepSeek-R1-Distill-Qwen-7B.
...
Model: deepseek-ai/DeepSeek-R1-Distill-Qwen-7B on cuda:1 (RTX PRO 4500 32GB)
Target modules: q_proj, k_proj, v_proj, o_proj, gate_proj, up_proj, down_proj
LoRA rank: 32, alpha: 128
Optimizer: AdamW + Cosine schedule, grad clipping 1.0, bfloat16.
Output: checkpoints/lora_recurrent_7b
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train LoRA curriculum for 7B continuous latent recurrence.")
    parser.add_argument("--traces_file", type=str, default="data/traces_gsm8k_7b.jsonl", help="Self-distilled traces path")
    parser.add_argument("--output_dir", type=str, default="checkpoints/lora_recurrent_7b", help="Output checkpoint directory")
...
def main():
    ...
    print(f"=== Stage 3: Continuous Latent Recurrence LoRA Training (7B) ===")
    ...
    print(f"\n=== 7B LoRA Training Finished Successfully ===")
